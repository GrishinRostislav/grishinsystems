  ...
  return (
    <div className={styles.dashboard}>
      ...
      {loading && !data ? (
        ...
        <>
          {/* Top Hero Section: Free Until Payday Card (Mockup 1) */}
          <div className={styles.freePaydayCard}>
            <div className={styles.freePaydayHeader}>
              <div className={styles.freePaydayMain}>
                <span className={styles.freePaydayTitle}>
                  <span>👁️</span> Free until Payday
                </span>
                <span className={styles.freePaydayAmount}>
                  {formatCurrency(Math.max(0, totalBalance), homeCurrency)}
                </span>
                <span className={styles.freePaydaySub}>12 days remaining in cycle</span>
              </div>
              <div className={styles.freePaydayRingContainer}>
                ...
                <span className={styles.freePaydayRingPercent}>73%</span>
              </div>
            </div>
            <div className={styles.paycheckPill}>
              <span>📅 Next Paycheck: 25 Nov 2025</span>
              <strong style={{ color: '#6ee7b7' }}>+{formatCurrency(2860, homeCurrency)}</strong>
            </div>
          </div>

          {/* Quick Action Bar (Mockup 1) */}
          <div className={styles.quickActionsRow}>
            <Link href="/accounts" className={styles.quickActionPill}>
              <span className={styles.quickActionIcon}>⇄</span>
              <span>Transfer</span>
            </Link>
            <label className={styles.quickActionPill} style={{ cursor: 'pointer' }}>
              <span className={styles.quickActionIcon}>📷</span>
              <span>Scan Receipt</span>
              <input type="file" accept="image/*" onChange={handleReceiptUpload} style={{ display: 'none' }} />
            </label>
            <Link href="/forecast" className={styles.quickActionPill}>
              <span className={styles.quickActionIcon}>📊</span>
              <span>Analytics</span>
            </Link>
            <Link href="/budgets" className={styles.quickActionPill}>
              <span className={styles.quickActionIcon}>⚖️</span>
              <span>Budget</span>
            </Link>
          </div>

          {/* Spend Comparison Insight Banner (Mockup 1) */}
          <Link href="/forecast" style={{ textDecoration: 'none' }}>
            <div className={styles.insightBanner}>
              <div className={styles.insightLeft}>
                <div className={styles.insightIcon}>💡</div>
                <div className={styles.insightText}>You spent 18% less than in previous month!</div>
              </div>
